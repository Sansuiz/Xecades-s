...
<span>
    ...
    <div id="text">
        ...
        <p>我现在是一名高三学生，在<a href="http://www.cdqz.net/" target="_blank" rel="noopener noreferrer">成都七中</a>学习<ruby><rb>信息学竞赛</rb><rt>AFO Since 2020</rt></ruby>和文化课。如果你恰好也是这个学校的学生，欢迎来高 2019 级 12 班找我。</p>
    ...
    props: [ "lab", "friend", "timeline", "sponsor" ]
};
...
<span>
    ...
    <div id="text" class="about">
        ...
        <p>他也追星，只不过追的是先秦诸子和中华豪杰：孔丘、李白、鲁迅，先生们是他一生的榜样。</p>
        <p>他不说脏话，现在不会，将来也不会，这是他的底线。但他并不反感那些偶尔说脏话的人，那些人只是想要发泄。</p>
        <p>他初中在<a href="http://mydcis.net/" target="_blank" rel="noopener noreferrer">绵阳东辰</a>就读，高中在<a href="http://www.cdqz.net/" target="_blank" rel="noopener noreferrer">成都七中</a>。从初中二年级到高中一年级，他曾是一名<ruby><rb>信竞选手</rb><rt>OIer</rt></ruby>，只不过那些知识他已经忘得差不多了。</p>
        <p>兴趣让他沉浸于有趣的知识不能自拔，他渴望知道更多、学习更多。他乐于创造，勤于思考，希望有一双能发现美的眼睛。</p>
        <p>他的 Telegram 账号是 <a href="https://t.me/Xecades" target="_blank" rel="noopener noreferrer">@Xecades</a>；Github 账号是 <a href="https://github.com/Xecades" target="_blank" rel="noopener noreferrer">@Xecades</a>；邮箱是 i#xecades.xyz。如果感兴趣，你可以通过这些渠道找到他。</p>
        <p>网站运营需要持续的开销，如果本站内容能给您带来启发，欢迎<router-link to="/sponsor"><ruby><rb>赞助</rb><rt>/sponsor</rt></ruby></router-link>。</p>
...
<span>
    <div id="title">赞助</div>
    <div id="text" class="sponsor">
        <p class="bold">谢谢你，陌生人。</p>
        <p class="img"><img src="/sponsor/wechat.png"/><img src="/sponsor/alipay.png"/></p>
        <p>你可以点击<router-link to="/"><ruby><rb>这里</rb><rt>/index</rt></ruby></router-link>返回主页。</p>
    </div>
</span>`,
    mounted() { CURSOR.refresh(); },
    props: [ "lab", "friend", "timeline", "sponsor" ]
...
const app = new Vue({
    ...
    data: {
        lab: [
            ...
            // { name: "Nazo",                     url: "https://nazo.xecades.xyz/",               desc: "网页解密游戏" },
        ...
        timeline: [
            ...
            },
            {
                ...
                meta: [
                    ...
                    { date: "6 月 7 日",            desc: "高二提前高考" },
                    { date: "暑假",                 desc: "第一个摆脱了电脑的暑假" },
                    { date: "补充",                 desc: "新爱好：Engraver's Script 英文书法" },
                ]
            },
        ]
    },
